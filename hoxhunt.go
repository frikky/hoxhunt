...
func (hoxhunt *HoxhuntData) ReopenIncident(incidentId string) {
	...
	fmt.Println(ret.StatusCode, err)
}

func (hoxhunt *HoxhuntData) CloseIncident(incidentId string) {
